...
<body>
	...
	<?php 
	 $BDProductos = array( 
    array(1, 2, 3, 4, 5, 6),                                       //El ID
    array("Blusa", "Lentes", "Playera", "Pantalón", "Vestido", "Zapato"), //La Descripción
    array(100, 350, 200, 420, 250, 220),                             //El Precio
    array("Dama", "Caballero", "Caballero", "Dama", "Dama", "Caballero"));   //Categoría
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 30 17 018</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> angelrenemarin0@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
